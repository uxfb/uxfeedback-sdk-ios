...
SWIFT_CLASS_NAMED("UXFRequest")
@interface UXFRequest : NSManagedObject
...
@interface UXFRequest (SWIFT_EXTENSION(UXFeedbackSDK))
@property (nonatomic, copy) NSString * _Nullable apiMethod;
...
- (void)setNetworkSettingsWithNetworkTimeout:(double)networkTimeout retryTimeout:(double)retryTimeout retryCount:(NSInteger)retryCount;
