...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
+ (void)setupWithAppID:(NSString * _Nonnull)appID settings:(UXFBSettings * _Nonnull)settings campainDelegate:(id <UXFeedbackCampaignDelegate> _Nullable)campainDelegate logDelegate:(id <UXFeedbackLogDelegate> _Nullable)logDelegate;
